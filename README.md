...
![Easel logo](https://github.com/lmr97/assets/icons/easel-icon-with-name.png | width=100)
...
- **Total data autonomy** so your profile data can be transferred over to an equivalent site with a better design if one is created; your data can also be self-hosted, so it can be really and truly yours
- **No lock-in whatsoever**, since it exists to describe your work, and forward interested traffic to the websites you like to use for payment and portfolios
